...
def main() -> int:
    ...
    passed = "0006_mcp.sql" in applied or {"mcp_grants", "mcp_problem_reports"} <= tables
    print(("PASS" if passed else "FAIL") + ": MCP grant migration")
    print("PHASE 6 QUALIFICATION: " + ("PASS" if passed else "FAIL"))
