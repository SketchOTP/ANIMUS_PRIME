...
def main() -> int:
    ...
    passed = "0003_onboarding.sql" in applied or {"project_bindings", "goal_revisions", "authority_revisions"} <= tables
    print(("PASS" if passed else "FAIL") + ": onboarding migration")
    print("PHASE 3 QUALIFICATION: " + ("PASS" if passed else "FAIL"))
