...
def main() -> int:
    ...
    passed = "0009_activity.sql" in applied or "activity_checkpoints" in tables
    print(("PASS" if passed else "FAIL") + ": activity migration")
    print("PHASE 9 QUALIFICATION: " + ("PASS" if passed else "FAIL"))
