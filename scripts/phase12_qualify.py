...
def main() -> int:
    ...
    passed = "0012_lifecycle.sql" in applied or {"lifecycle_operations", "remote_access_status"} <= tables
    print(("PASS" if passed else "FAIL") + ": lifecycle migration")
    print("PHASE 12 QUALIFICATION: " + ("PASS" if passed else "FAIL"))
