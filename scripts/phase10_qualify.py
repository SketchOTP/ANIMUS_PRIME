...
def main() -> int:
    ...
    passed = "0010_brain.sql" in applied or "brain_snapshots" in tables
    print(("PASS" if passed else "FAIL") + ": Brain migration")
    print("PHASE 10 QUALIFICATION: " + ("PASS" if passed else "FAIL"))
