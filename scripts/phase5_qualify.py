...
def main() -> int:
    ...
    passed = "0005_memory.sql" in applied or {"memory_records", "memory_corrections"} <= tables
    print(("PASS" if passed else "FAIL") + ": memory ledger migration")
    print("PHASE 5 QUALIFICATION: " + ("PASS" if passed else "FAIL"))
