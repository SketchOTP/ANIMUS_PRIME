...
def main() -> int:
    ...
    passed = "0008_progress.sql" in applied or {"progress_baseline_reviews", "goal_items", "progress_assessments"} <= tables
    print(("PASS" if passed else "FAIL") + ": progress migration")
    print("PHASE 8 QUALIFICATION: " + ("PASS" if passed else "FAIL"))
