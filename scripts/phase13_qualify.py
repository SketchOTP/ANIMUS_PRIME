...
def main() -> int:
    ...
    passed = "0013_reliability.sql" in applied or {"backup_records", "diagnostic_samples"} <= tables
    print(("PASS" if passed else "FAIL") + ": reliability migration")
    print("PHASE 13 QUALIFICATION: " + ("PASS" if passed else "FAIL"))
